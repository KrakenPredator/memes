...
public class JuegosRestController {
	...
	private void initDatabase() {
		Juego cod = new Juego("Call Of Dutty WII", 49.95, "Sledgehammer Games", "Activision", "Acción, Primera persona (FPS)(Bélico, Zombies, Segunda Guerra Mundial y Paramilitares y mercenarios)", "1-12 (Competitivo: 12 online / Cooperativo: 4 online)", "5-6 horas + multijugador incalculable", "Textos en español y voces en español", "3/11/2017", "18", "TSYqDvTLOYU", "resources/codCover.jpg_large");
		juegoRepository.save(cod);
		Juego pubg = new Juego("Player Unknown's Battlegrounds", 24.95, "Bluehole Studio", "Bluehole, Inc.", "Acción, Primera persona (FPS), Battle royale, Supervivencia, Shooter (Bélico, Moderno y Paramilitares y mercenarios)", "100 (1 a 4 por equipo) (Competitivo: Sí, online / Cooperativo: Sí, online)", "Incalculable", "Textos en español y voces en inglés","26/1/2018","12", "TSYqDvTLOYU", "resources/pubgCover.jpg");
		juegoRepository.save(pubg);
		Juego dbz = new Juego("Dragon Ball Fighter Z", 39.95, "Arc System Works", "Bandai Namco", "Acción, Lucha (Anime, Manga y TV)", "1-6 (2 local - 6 online) (Competitivo: Sí / Cooperativo: Sí)", "9-10 horas + multijugador incalculable", "Textos en español y voces en inglés y japonés", "20/12/2017", "18", "TSYqDvTLOYU", "resources/dbfCover.jpg");

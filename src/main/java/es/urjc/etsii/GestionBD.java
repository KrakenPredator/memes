...
public class GestionBD {
    ...
    public static boolean conectar() {
        ...
        try {
            conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/gameFlix?serverTimezone=UTC", "root", "");
            connected = true;
    ...
    public static void crearTabla() {
        String createSql = "CREATE TABLE users (iduser INT NOT NULL AUTO_INCREMENT, "
    ...
    public static void insertarDatos() {
        String insertSql = "INSERT INTO usuarios (username,pass) VALUES ('Manuel Viejo','1234'),('Prueba probador','4567')";
        Statement statement;
        try {
            statement = conn.createStatement();
